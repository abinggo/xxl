...
import { APPROACH, LANE_X, JUDGE_Y, TARGET_R, RING_EXTRA, COLORS } from "./config.js?v=1785379502";
import { createFx } from "./fx.js?v=1785379502";
import { createCharacter } from "./character.js?v=1785379502";
