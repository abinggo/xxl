...
import { APPROACH, LANE_X, JUDGE_Y, TARGET_R, RING_EXTRA, COLORS } from "./config.js?v=1785382353";
import { createFx } from "./fx.js?v=1785382353";
import { createCharacter } from "./character.js?v=1785382353";
