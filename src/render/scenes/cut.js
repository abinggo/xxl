...
import { COLORS } from "../config.js?v=1785334738";
import { hexA } from "../stage.js?v=1785334738";
import { clamp, lerp } from "./base.js?v=1785334738";
...
export function createCut(stage, game) {
  ...
  function drawPenguin(c, t, bands, fv) {
    ...
    if (PENG) {
      ...
      c.translate(cx, cy);
      c.rotate(tilt);
      c.shadowColor = hexA(fv ? GOLD : ACCENT, 0.9); c.shadowBlur = 26 + pengPulse * 20;
