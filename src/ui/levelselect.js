// 单入口标题页 + 关卡地图(世界×小关)
import { WORLDS, getProgress, isUnlocked, levelStars } from "../data/levels.js?v=1785390451";
...
export function renderHome(root, { songs, onStart, onCustom, onLeaderboard, onPrizes, prizeCount = 0 }) {
  ...
  el.innerHTML = `
    <div class="cover">
      ...
      <button class="cover__prizebtn" id="prizeBtn" type="button">🎁 我的奖品${prizeCount ? `<b>${prizeCount}</b>` : ""}</button>
  ...
  el.querySelector("#prizeBtn").addEventListener("click", () => onPrizes && onPrizes());
