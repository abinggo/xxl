...
import { getAudio, unlockAudio } from "./audio/context.js?v=1785382353";
import { TRACKS, compileTrack, sprinkleItems } from "./data/tracks.js?v=1785382353";
import { getIP, loadIPSprites } from "./data/ip.js?v=1785382353";
import { recordClear, getProgress, WORLDS } from "./data/levels.js?v=1785382353";
import { createGame } from "./core/engine.js?v=1785382353";
import { renderHome } from "./ui/levelselect.js?v=1785382353";
import { renderResult } from "./ui/result.js?v=1785382353";
import { generateBeatmap } from "./core/generator.js?v=1785382353";
import { createMusicPlayer } from "./audio/synth.js?v=1785382353";
import { createBufferPlayer } from "./audio/decoded.js?v=1785382353";
